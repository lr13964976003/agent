...
# Read the DOT file and create a simple SVG manually
...
# Write the corrected DOT file
with open('./outputs/2025-12-26-10-50-02/parallel_strategy_deployment.dot', 'w') as f:
    f.write(dot_content)

print("Corrected DOT file written successfully!")
print("The file now includes the missing MoE block in Stage 2 with:")
print("- moe_gate2 node")
print("- expert_route2 node") 
print("- expert_2 and expert_3 nodes")
print("- expert_combine2 node")
print("- moe_residual2 node")
print("All properly connected from residual2 -> moe_gate2 -> ... -> final_layernorm")