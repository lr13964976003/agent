...
# Create the comprehensive DAG for 10B MoE Transformer with 4D hybrid parallelism
dag_content = '''digraph G {
    // Graph settings
    nodesep=0.8;
    rankdir=TB;
    ranksep=1.2;
...
# Write the DAG content to a .dot file
with open('./outputs/2025-12-26-10-50-02/parallel_strategy_deployment.dot', 'w') as f:
    f.write(dag_content)

print("DAG file created: parallel_strategy_deployment.dot")

# Generate SVG image using graphviz
os.system('dot -Tsvg ./outputs/2025-12-26-10-50-02/parallel_strategy_deployment.dot -o ./outputs/2025-12-26-10-50-02/parallel_strategy_deployment.svg')
print("SVG image created: parallel_strategy_deployment.svg")