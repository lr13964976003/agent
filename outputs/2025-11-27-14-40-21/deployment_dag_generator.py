...
def generate_dag():
    ...
    subgraph cluster_layer4_moe {
        ...
        subgraph cluster_mla_moe4 {
            ...
            // Q projection for each EP group
            mla_q_moe4_ep0_0 [shape=ellipse, style=filled, fillcolor=lightyellow,
                            label="GPU: 0\nQ Proj EP0-TP0\nInput: [batch_size=8, seq_len=2048, hidden=7168]\nOutput: [batch_size=8, seq_len=2048, heads=16, d_k=56]"];
            mla_q_moe4_ep0_1 [shape=ellipse, style=filled, fillcolor=lightyellow,
                            label="GPU: 1\nQ Proj EP0-TP1\nInput: [batch_size=8, seq_len=2048, hidden=7168]\nOutput: [batch_size=8, seq_len=2048, heads=16, d_k=56]"];
            // Similar for other EP groups...
            mla_q_moe4_ep15_7 [shape=ellipse, style=filled, fillcolor=lightyellow,
                             label="GPU: 127\nQ Proj EP15-TP7\nInput: [batch_size=8, seq_len=2048, hidden=7168]\nOutput: [batch_size=8, seq_len=2048, heads=16, d_k=56]"];
            
            // K/V projection
            mla_kv_moe4_ep0_0 [shape=ellipse, style=filled, fillcolor=lightcoral,
                             label="GPU: 0\nK/V Proj EP0-TP0\nInput: [batch_size=8, seq_len=2048, hidden=7168]\nOutput: [batch_size=8, seq_len=2048, heads=16, d_k=56, kv_compressed=512]"];
            
            // Attention computation
            attn_moe4_ep0_0 [shape=rectangle, style=filled, fillcolor=lightgreen,
                           label="GPU: 0\nAttention Compute EP0-TP0\nInput: [batch_size=8, seq_len=2048, heads=16, d_k=56]\nOutput: [batch_size=8, seq_len=2048, heads=16, d_k=56]"];
            
            // Output projection
            out_proj_moe4_ep0_0 [shape=parallelogram, style=filled, fillcolor=lightblue,
                               label="GPU: 0\nOutput Proj EP0-TP0\nInput: [batch_size=8, seq_len=2048, heads=16, d_k=56]\nOutput: [batch_size=8, seq_len=2048, hidden=896]"];
        ...
        subgraph cluster_experts_moe4 {
            ...
            // Expert 1 (similar structure, different tokens)
            ...
            // Continue pattern for experts 2-127 (simplified representation)
            expert127_moe4_gate [shape=ellipse, style=filled, fillcolor=lightsteelblue,
                               label="GPU: 127\nExpert 127 Gate\nInput: [tokens=varies, hidden=7168]\nOutput: [tokens=varies, hidden=7168, gate_weights=varies]"];
        }
    ...
    // Layer 5 - MoE Layer (Second representative MoE layer)
    subgraph cluster_layer5_moe {
        label="Layer 5 - MoE Layer (EP=16, TP=8, DP=4)";
        style=dashed;
        color=red;
        
        // Similar structure to Layer 4 but with different GPU assignments
        // Simplified representation - follows same pattern
        mla_moe5_overview [shape=rectangle, style=filled, fillcolor=lightgray,
                          label="GPU: 0-127\nMLA + Expert Processing\n(Parallel execution across all GPUs)\nInput: [batch_size=32, seq_len=2048, hidden=7168]\nOutput: [batch_size=32, seq_len=2048, hidden=7168]"];
    }
    
    // Layer 6 - MoE Layer (Third representative MoE layer)
    subgraph cluster_layer6_moe {
        label="Layer 6 - MoE Layer (EP=16, TP=8, DP=4)";
        style=dashed;
        color=red;
        
        // Final layer before output
        mla_moe6_overview [shape=rectangle, style=filled, fillcolor=lightgray,
                          label="GPU: 0-127\nFinal MLA + Expert Processing\n(Parallel execution across all GPUs)\nInput: [batch_size=32, seq_len=2048, hidden=7168]\nOutput: [batch_size=32, seq_len=2048, hidden=7168]"];
    }
    ...
    input_node -> mla_q_dense1_1 [style=solid];
    input_node -> mla_q_dense1_2 [style=solid];
    input_node -> mla_q_dense1_3 [style=solid];
    input_node -> mla_q_dense1_4 [style=solid];
    input_node -> mla_q_dense1_5 [style=solid];
    input_node -> mla_q_dense1_6 [style=solid];
    input_node -> mla_q_dense1_7 [style=solid];
    ...
    // Similar connections for other TP splits...
    mla_q_dense1_1 -> attn_dense1_1 [style=solid];
    mla_kv_dense1_1 -> attn_dense1_1 [style=solid];
    attn_dense1_1 -> out_proj_dense1_1 [style=solid];
    
    // All-reduce for attention
    out_proj_dense1_0 -> attn_allreduce_dense1 [style=solid];
    out_proj_dense1_1 -> attn_allreduce_dense1 [style=solid];
    out_proj_dense1_2 -> attn_allreduce_dense1 [style=solid];
    out_proj_dense1_3 -> attn_allreduce_dense1 [style=solid];
    out_proj_dense1_4 -> attn_allreduce_dense1 [style=solid];
    out_proj_dense1_5 -> attn_allreduce_dense1 [style=solid];
    out_proj_dense1_6 -> attn_allreduce_dense1 [style=solid];
    out_proj_dense1_7 -> attn_allreduce_dense1 [style=solid];
    
    // MLP connections
    attn_allreduce_dense1 -> mlp_linear1_dense1_0 [style=solid];
    attn_allreduce_dense1 -> mlp_linear1_dense1_1 [style=solid];
    attn_allreduce_dense1 -> mlp_linear1_dense1_2 [style=solid];
    attn_allreduce_dense1 -> mlp_linear1_dense1_3 [style=solid];
    attn_allreduce_dense1 -> mlp_linear1_dense1_4 [style=solid];
    attn_allreduce_dense1 -> mlp_linear1_dense1_5 [style=solid];
    attn_allreduce_dense1 -> mlp_linear1_dense1_6 [style=solid];
    attn_allreduce_dense1 -> mlp_linear1_dense1_7 [style=solid];
    ...
    mlp_linear2_dense1_1 -> mlp_allreduce_dense1 [style=solid];
    mlp_linear2_dense1_2 -> mlp_allreduce_dense1 [style=solid];
    mlp_linear2_dense1_3 -> mlp_allreduce_dense1 [style=solid];
    mlp_linear2_dense1_4 -> mlp_allreduce_dense1 [style=solid];
    mlp_linear2_dense1_5 -> mlp_allreduce_dense1 [style=solid];
    mlp_linear2_dense1_6 -> mlp_allreduce_dense1 [style=solid];
    mlp_linear2_dense1_7 -> mlp_allreduce_dense1 [style=solid];
    ...
    token_routing_moe4 -> expert127_moe4_gate [style=dashed, label="Token routing"];
    ...
    expert127_moe4_gate -> expert_aggregation_moe4 [style=dashed, label="Expert result"];
    
    // Layer connections
    expert_aggregation_moe4 -> mla_moe5_overview [style=solid];
    mla_moe5_overview -> mla_moe6_overview [style=solid];
    mla_moe6_overview -> output_node [style=solid];
    
    // Residual connections (shown as additional inputs)
    attn_allreduce_dense1 -> mlp_linear1_dense1_0 [style=dashed, label="Residual", constraint=false];
    expert_aggregation_moe4 -> mla_moe5_overview [style=dashed, label="Residual", constraint=false];
}
'''
...
if __name__ == "__main__":
    ...
    from Extract Info From DAG import extract_dag_info
