...
def generate_llm_deployment_dag():
    ...
    // Define colors for different GPU groups (using hex colors)
    ...
    // Expert outputs to all-reducen    GPU0_Expert00 -> Expert_AllReduce;
...
def main():
    ...
    # Save the DOT file
    dot_file_path = "../outputs/2025-12-05-16-42-10/llm_deployment_dag_fixed.dot"
    ...
    try:
        import subprocess
        svg_file_path = "../outputs/2025-12-05-16-42-10/llm_deployment_dag_fixed.svg"
    ...
    import json
    json_path = "../outputs/2025-12-05-16-42-10/dag_submission_paths_fixed.json"
