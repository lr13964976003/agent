...
def create_moe_dag():
    ...
    dot.attr('ellipse', shape='ellipse', style='filled', fillcolor='lightyellow')
    dot.attr('parallelogram', shape='parallelogram', style='filled', fillcolor='lightgreen')
