...
def main():
    ...
    submission = {
        "baseline_dag": str(output_dir / "baseline_dag_corrected.dot"),
        "helix_dag": str(output_dir / "helix_dag_corrected.dot"),
        "baseline_svg": str(output_dir / "baseline_dag_corrected.svg"),
        "helix_svg": str(output_dir / "helix_dag_corrected.svg"),
        "validation_results": results
    }
    
    import json
    with open(output_dir / "submission_paths.json", "w") as f:
        json.dump(submission, f, indent=2)
    
    print(f"\n✓ Submission paths written to {output_dir / 'submission_paths.json'}")
