...
def main():
    ...
    # Save DOT file
    dot_path = '../outputs/2025-12-22-11-52-26/llm_deployment_dag_comprehensive.dot'
    dag.save(dot_path)
    
    # Save SVG image
    svg_path = '../outputs/2025-12-22-11-52-26/llm_deployment_dag_comprehensive.svg'
    dag.render('../outputs/2025-12-22-11-52-26/llm_deployment_dag_comprehensive', format='svg', cleanup=True)
