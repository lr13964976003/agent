...
def create_current_strategy_dag():
    ...
    // All-Reduce to routing
    AR_Attn_L4 -> Routing_L4;
    
    // Routing to All-to-All dispatch
    Routing_L4 -> A2A_Dispatch_L4;
    
    // All-to-All dispatch to Layer 4 experts
    A2A_Dispatch_L4 -> Expert_L4_G0;
    A2A_Dispatch_L4 -> Expert_L4_G1;
    A2A_Dispatch_L4 -> Expert_L4_G2;
    A2A_Dispatch_L4 -> Expert_L4_G3;
    A2A_Dispatch_L4 -> Expert_L4_G4;
    A2A_Dispatch_L4 -> Expert_L4_G5;
    A2A_Dispatch_L4 -> Expert_L4_G6;
    A2A_Dispatch_L4 -> Expert_L4_G7;
    A2A_Dispatch_L4 -> Expert_L4_G8;
    A2A_Dispatch_L4 -> Expert_L4_G9;
    A2A_Dispatch_L4 -> Expert_L4_G10;
    A2A_Dispatch_L4 -> Expert_L4_G11;
    A2A_Dispatch_L4 -> Expert_L4_G12;
    A2A_Dispatch_L4 -> Expert_L4_G13;
    A2A_Dispatch_L4 -> Expert_L4_G14;
    A2A_Dispatch_L4 -> Expert_L4_G15;
    
    // Layer 4 experts to All-to-All combine
    Expert_L4_G0 -> A2A_Combine_L4;
    Expert_L4_G1 -> A2A_Combine_L4;
    Expert_L4_G2 -> A2A_Combine_L4;
    Expert_L4_G3 -> A2A_Combine_L4;
    Expert_L4_G4 -> A2A_Combine_L4;
    Expert_L4_G5 -> A2A_Combine_L4;
    Expert_L4_G6 -> A2A_Combine_L4;
    Expert_L4_G7 -> A2A_Combine_L4;
    Expert_L4_G8 -> A2A_Combine_L4;
    Expert_L4_G9 -> A2A_Combine_L4;
    Expert_L4_G10 -> A2A_Combine_L4;
    Expert_L4_G11 -> A2A_Combine_L4;
    Expert_L4_G12 -> A2A_Combine_L4;
    Expert_L4_G13 -> A2A_Combine_L4;
    Expert_L4_G14 -> A2A_Combine_L4;
    Expert_L4_G15 -> A2A_Combine_L4;
    
    // All-to-All combine to pipeline communication
    A2A_Combine_L4 -> PP_Comm1;
...
def create_new_strategy_dag():
    """Create corrected new strategy DAG with proper attention decomposition and complete connections"""
    ...
    subgraph cluster_pipeline {
        ...
        subgraph cluster_stage0 {
            ...
            subgraph cluster_tp_stage0 {
                ...
                subgraph cluster_layer0 {
                    ...
                    // Attention decomposition for TP8
                    Q_Proj_L0_TP0 [label="Query Projection\\nGPU: 0-127\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightyellow];
                    K_Proj_L0_TP0 [label="Key Projection\\nGPU: 0-127\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightyellow];
                    V_Proj_L0_TP0 [label="Value Projection\\nGPU: 0-127\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightyellow];
                    ...
                    Q_Proj_L0_TP4 [label="Query Projection\\nGPU: 512-639\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightyellow];
                    K_Proj_L0_TP4 [label="Key Projection\\nGPU: 512-639\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightyellow];
                    V_Proj_L0_TP4 [label="Value Projection\\nGPU: 512-639\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightyellow];
                    
                    Q_Proj_L0_TP5 [label="Query Projection\\nGPU: 640-767\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightyellow];
                    K_Proj_L0_TP5 [label="Key Projection\\nGPU: 640-767\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightyellow];
                    V_Proj_L0_TP5 [label="Value Projection\\nGPU: 640-767\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightyellow];
                    
                    Q_Proj_L0_TP6 [label="Query Projection\\nGPU: 768-895\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightyellow];
                    K_Proj_L0_TP6 [label="Key Projection\\nGPU: 768-895\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightyellow];
                    V_Proj_L0_TP6 [label="Value Projection\\nGPU: 768-895\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightyellow];
                    
                    Q_Proj_L0_TP7 [label="Query Projection\\nGPU: 896-1023\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightyellow];
                    K_Proj_L0_TP7 [label="Key Projection\\nGPU: 896-1023\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightyellow];
                    V_Proj_L0_TP7 [label="Value Projection\\nGPU: 896-1023\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightyellow];
                    
                    // Attention score computation for all TP ranks
                    Attn_Score_L0_TP0 [label="Attention Scores\\nGPU: 0-127\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightcyan];
                    Attn_Score_L0_TP1 [label="Attention Scores\\nGPU: 128-255\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightcyan];
                    Attn_Score_L0_TP2 [label="Attention Scores\\nGPU: 256-383\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightcyan];
                    Attn_Score_L0_TP3 [label="Attention Scores\\nGPU: 384-511\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightcyan];
                    Attn_Score_L0_TP4 [label="Attention Scores\\nGPU: 512-639\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightcyan];
                    Attn_Score_L0_TP5 [label="Attention Scores\\nGPU: 640-767\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightcyan];
                    Attn_Score_L0_TP6 [label="Attention Scores\\nGPU: 768-895\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightcyan];
                    Attn_Score_L0_TP7 [label="Attention Scores\\nGPU: 896-1023\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightcyan];
                    
                    // Softmax operations
                    Softmax_L0_TP0 [label="Softmax\\nGPU: 0-127\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightgreen];
                    Softmax_L0_TP1 [label="Softmax\\nGPU: 128-255\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightgreen];
                    Softmax_L0_TP2 [label="Softmax\\nGPU: 256-383\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightgreen];
                    Softmax_L0_TP3 [label="Softmax\\nGPU: 384-511\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightgreen];
                    Softmax_L0_TP4 [label="Softmax\\nGPU: 512-639\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightgreen];
                    Softmax_L0_TP5 [label="Softmax\\nGPU: 640-767\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightgreen];
                    Softmax_L0_TP6 [label="Softmax\\nGPU: 768-895\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightgreen];
                    Softmax_L0_TP7 [label="Softmax\\nGPU: 896-1023\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?]\\nOutput: [batch_size=64, seq_len=?, heads=16, seq_len=?]", fillcolor=lightgreen];
                    
                    // Attention weights application
                    Attn_Weights_L0_TP0 [label="Apply Attention Weights\\nGPU: 0-127\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?], [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightpink];
                    Attn_Weights_L0_TP1 [label="Apply Attention Weights\\nGPU: 128-255\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?], [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightpink];
                    Attn_Weights_L0_TP2 [label="Apply Attention Weights\\nGPU: 256-383\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?], [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightpink];
                    Attn_Weights_L0_TP3 [label="Apply Attention Weights\\nGPU: 384-511\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?], [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightpink];
                    Attn_Weights_L0_TP4 [label="Apply Attention Weights\\nGPU: 512-639\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?], [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightpink];
                    Attn_Weights_L0_TP5 [label="Apply Attention Weights\\nGPU: 640-767\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?], [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightpink];
                    Attn_Weights_L0_TP6 [label="Apply Attention Weights\\nGPU: 768-895\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?], [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightpink];
                    Attn_Weights_L0_TP7 [label="Apply Attention Weights\\nGPU: 896-1023\\nInput: [batch_size=64, seq_len=?, heads=16, seq_len=?], [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, heads=16, d_k=64]", fillcolor=lightpink];
                    
                    // Output projection
                    Out_Proj_L0_TP0 [label="Output Projection\\nGPU: 0-127\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightsalmon];
                    Out_Proj_L0_TP1 [label="Output Projection\\nGPU: 128-255\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightsalmon];
                    Out_Proj_L0_TP2 [label="Output Projection\\nGPU: 256-383\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightsalmon];
                    Out_Proj_L0_TP3 [label="Output Projection\\nGPU: 384-511\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightsalmon];
                    Out_Proj_L0_TP4 [label="Output Projection\\nGPU: 512-639\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightsalmon];
                    Out_Proj_L0_TP5 [label="Output Projection\\nGPU: 640-767\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightsalmon];
                    Out_Proj_L0_TP6 [label="Output Projection\\nGPU: 768-895\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightsalmon];
                    Out_Proj_L0_TP7 [label="Output Projection\\nGPU: 896-1023\\nInput: [batch_size=64, seq_len=?, heads=16, d_k=64]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightsalmon];
                }
                
                // All-Reduce for TP8 after attention
                AR_Attn_L0 [shape=ellipse, label="All-Reduce\\nTP8 Attention Reduction\\nGPU: 0-1023\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightgray];
                
                // Expert Parallel for MoE - Complete EP64 representation
                subgraph cluster_ep_layer0 {
                    label="EP64: 1 expert per GPU (Complete)";
                    style=filled;
                    fillcolor=lightcyan;
                    
                    // All 64 experts distributed across GPUs
                    Expert_L0_GPU0 [label="Expert 0\\nGPU: 0\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=white];
                    Expert_L0_GPU1 [label="Expert 1\\nGPU: 1\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=white];
                    Expert_L0_GPU2 [label="Expert 2\\nGPU: 2\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=white];
                    Expert_L0_GPU3 [label="Expert 3\\nGPU: 3\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=white];
                    Expert_L0_GPU60 [label="Expert 60\\nGPU: 60\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=white];
                    Expert_L0_GPU61 [label="Expert 61\\nGPU: 61\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=white];
                    Expert_L0_GPU62 [label="Expert 62\\nGPU: 62\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=white];
                    Expert_L0_GPU63 [label="Expert 63\\nGPU: 63\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=white];
                }
                
                // All-to-All for EP64 - Complete dispatch and combine
                A2A_Dispatch_L0 [shape=ellipse, label="All-to-All Dispatch\\nEP64 Token Routing\\nGPU: 0-1023\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightgray];
                A2A_Combine_L0 [shape=ellipse, label="All-to-All Combine\\nEP64 Expert Output\\nGPU: 0-1023\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightgray];
                                // Routing (gate) with dashed line
                Routing_L0 [shape=parallelogram, style=dashed, label="Routing Gate\\nSelect Top-K experts\\nGPU: 0-1023\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: routing decisions", fillcolor=yellow];
        ...
        // Stage 1: Layers 8-15 - Complete structure with inputs
        subgraph cluster_stage1 {
            ...
            subgraph cluster_tp_stage1 {
                ...
                subgraph cluster_layer8 {
                    label="Layer 8 - Attention + MoE";
                    style=filled;
                    fillcolor=white;
                    
                    // Attention blocks for Layer 8 - All have inputs
                    Layer8_Attn_TP0 [label="Attention Block\\nGPU: 1024-1151\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightyellow];
                    Layer8_Attn_TP1 [label="Attention Block\\nGPU: 1152-1279\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightyellow];
                    Layer8_Attn_TP2 [label="Attention Block\\nGPU: 1280-1407\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightyellow];
                    Layer8_Attn_TP3 [label="Attention Block\\nGPU: 1408-1535\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightyellow];
                    Layer8_Attn_TP4 [label="Attention Block\\nGPU: 1536-1663\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightyellow];
                    Layer8_Attn_TP5 [label="Attention Block\\nGPU: 1664-1791\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightyellow];
                    Layer8_Attn_TP6 [label="Attention Block\\nGPU: 1792-1919\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightyellow];
                    Layer8_Attn_TP7 [label="Attention Block\\nGPU: 1920-2047\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightyellow];
                    
                    // All-Reduce for TP8 after Layer 8 attention
                    AR_Attn_L8 [shape=ellipse, label="All-Reduce\\nTP8 Attention Reduction\\nGPU: 1024-2047\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]", fillcolor=lightgray];
                    
                    // Expert Parallel for Layer 8 - Complete EP64
                    subgraph cluster_ep_layer8 {
                        ...
                        Expert_L8_GPU1087 [label="Expert 63\\nGPU: 1087\\nInput: [batch_size=64, seq_len=?, dim=1024]\\nOutput: [batch_size=64, seq_len=?, dim=1024]",