...
def generate_simplified_dag():
    """Generate a simplified DAG focusing on 3 representative layers with proper connectivity"""
    
    dot_content = '''// Large-Scale Cross-Node Expert Parallelism DAG - Simplified 3-Layer Representation
digraph {
    rankdir=LR
...
def main():
    ...
    dot_content = generate_simplified_dag()
    
    # Save the DOT file
    dot_file_path = "../outputs/2025-11-28-16-11-17/large_ep_dag_simplified.dot"
    with open(dot_file_path, 'w') as f:
        f.write(dot_content)
    
    print(f"Generated simplified DAG file: {dot_file_path}")
    
    # Generate SVG image using graphviz
    try:
        svg_file_path = "../outputs/2025-11-28-16-11-17/large_ep_dag_simplified.svg"
