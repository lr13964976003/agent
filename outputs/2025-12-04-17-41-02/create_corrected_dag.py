...
''')
        ...
        # Connect remaining experts and final connections
        f.write('''
    experts_remaining_1 -> expert_agg_1 [label="Experts 8-63 outputs"];
