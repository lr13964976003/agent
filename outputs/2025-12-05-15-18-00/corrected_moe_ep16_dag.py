#!/usr/bin/env python3
"""
Corrected MoE EP16 DAG Generator
Fixes all issues identified in the validation report:
1. Properly represents 16-way expert parallelism
2. Includes GPU-to-GPU communication nodes
3. Fixes in-degree/out-degree violations
4. Shows complete expert routing and aggregation
"""

def generate_corrected_moe_ep16_dag():
    """Generate a corrected DOT file for MoE EP16 strategy"""
    
    dot_content = '''digraph MoE_EP16_Corrected {
    rankdir=LR;
    splines=true;
...
if __name__ == "__main__":
    ...
    dot_content = generate_corrected_moe_ep16_dag()
    
    # Write to file
    with open("../outputs/2025-12-05-15-18-00/moe_ep16_corrected_dag.dot", "w") as f:
        f.write(dot_content)
    
    print("✅ Corrected MoE EP16 DAG generated successfully!")
    print("✅ Fixed issues:")
    print("  - Proper 16-way expert parallelism")
    print("  - Added GPU-to-GPU communication nodes (AllToAll)")
    print("  - Fixed in-degree/out-degree violations")
    print("  - Complete expert routing and aggregation")