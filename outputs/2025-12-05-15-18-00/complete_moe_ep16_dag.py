#!/usr/bin/env python3
"""
Complete MoE EP16 DAG Generator
Creates a fully connected DAG with all 16 layers, proper expert parallelism,
GPU communication, and correct in-degree/out-degree connectivity.
"""

def generate_complete_moe_ep16_dag():
    """Generate a complete DOT file for MoE EP16 strategy with all layers"""
    
    dot_content = '''digraph MoE_EP16_Complete {
    rankdir=LR;
    splines=true;
    ...
    // Graph metadata
    labelloc="t";
    label="Complete MoE EP16 DAG – 16 Layers, 16-way Expert Parallelism";
...
if __name__ == "__main__":
    ...
    dot_content = generate_complete_moe_ep16_dag()
    
    # Write to file
    with open("../outputs/2025-12-05-15-18-00/moe_ep16_complete_dag.dot", "w") as f:
        f.write(dot_content)
    
    print("✅ Complete MoE EP16 DAG generated successfully!")
    print("✅ Features:")
    print("  - All 16 layers with proper connectivity")
    print("  - 16-way expert parallelism (64 experts total)")
    print("  - GPU-to-GPU communication nodes (AllToAll)")
    print("  - Proper in-degree/out-degree for all nodes")
