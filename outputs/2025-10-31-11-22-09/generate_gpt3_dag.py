#!/usr/bin/env python3
"""
Generate GPT3-2B DAG with HPipe token-dimension pipeline parallelism
"""
...
def create_gpt3_hpipe_dag():
    """Create GPT3-2B HPipe DAG"""
    dot = graphviz.Digraph(comment='GPT3-2B HPipe Pipeline Parallelism', format='svg')
    ...
    device_mapping = {
        'P@1': {'layers': [1, 2, 3, 4], 'type': 'P100', 'host': 'host1'},
        'P@2': {'layers': [5, 6, 7, 8], 'type': 'P100', 'host': 'host1'},
        'P@3': {'layers': [9, 10, 11, 12], 'type': 'P100', 'host': 'host1'},
        'P@4': {'layers': [13, 14, 15, 16], 'type': 'P100', 'host': 'host1'},
        'R@1': {'layers': [17, 18, 19, 20], 'type': 'RTX3090', 'host': 'host2'},
        'R@2': {'layers': [21, 22, 23, 24], 'type': 'RTX3090', 'host': 'host2'}
    }
    ...
    dot.edge('layer_24_ffn_norm', final_comm)
...
if __name__ == '__main__':
    dag = create_gpt3_hpipe_dag()
    dag.save('../outputs/2025-10-31-11-22-09/gpt3_2b_hpipe')
    print("GPT3-2B HPipe DAG saved")