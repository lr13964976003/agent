...
# Generate complete LLaMA-7B HPipe DAG
dot_content = """digraph llama_7b_hpipe {
    rankdir=TB;
...
with open('../outputs/2025-10-31-11-22-09/llama_7b_hpipe_complete.dot', 'w') as f:
    f.write(dot_content)

print("Complete LLaMA-7B HPipe DAG generated successfully")

# Also generate GPT3-2B DAG
gpt3_content = """digraph gpt3_2b_hpipe {
    rankdir=TB;
    node [shape=rectangle, fontname="Arial"];
...
with open('../outputs/2025-10-31-11-22-09/gpt3_2b_hpipe_complete.dot', 'w') as f:
    f.write(gpt3_content)

print("Complete GPT3-2B HPipe DAG generated successfully")