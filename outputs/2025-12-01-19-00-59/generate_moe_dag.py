...
def main():
    ...
    # Save DOT file
    dot_path = '/home/wzc/app/agent/paper_to_dag/outputs/2025-12-01-19-00-59/moe_single_gpu_deployment.dot'
    dag.save(dot_path.replace('.dot', ''))
    
    # Render to SVG
    svg_path = '/home/wzc/app/agent/paper_to_dag/outputs/2025-12-01-19-00-59/moe_single_gpu_deployment.svg'
    dag.render(dot_path.replace('.dot', ''), format='svg', cleanup=True)
