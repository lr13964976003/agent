...
class ParallelStrategyOptimizer:
    ...
    def optimize_parallel_strategy(self) -> ParallelConfig:
        ...
        # Choose optimal expert parallel size
        expert_parallel_size = 16  # Good balance: 4 experts per GPU
        ...
        # FIXED: Debug the GPU calculation
        print(f"DEBUG: tensor_parallel_size = {tensor_parallel_size}")
        print(f"DEBUG: pipeline_parallel_size = {pipeline_parallel_size}")
        print(f"DEBUG: expert_parallel_size = {expert_parallel_size}")
        print(f"DEBUG: data_parallel_size = {data_parallel_size}")
        ...
        print(f"DEBUG: total_gpus calculation = {tensor_parallel_size} * {pipeline_parallel_size} * {expert_parallel_size} * {data_parallel_size} = {total_gpus}")
...
if __name__ == "__main__":
    ...
    with open('../outputs/2025-12-04-14-18-19/parallel_config_fixed.json', 'w') as f:
        json.dump(config_dict, f, indent=2)
    
    print("Configuration saved to parallel_config_fixed.json")