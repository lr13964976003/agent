...
digraph CurrentStrategy {
    ...
    subgraph cluster_stage0 {
        ...
        subgraph cluster_layer0_moe {
            ...
            l0_expert_0 [label="L0-Expert-0\\nEP64[0-15]\\nIn: [1,1024,1024]\\nOut: [1,1024,1024]", shape=rectangle, fillcolor=lightblue, style=filled];
            l0_expert_1 [label="L0-Expert-1\\nEP64[16-31]\\nIn: [1,1024,1024]\\nOut: [1,1024,1024]", shape=rectangle, fillcolor=lightblue, style=filled];
            l0_expert_2 [label="L0-Expert-2\\nEP64[32-47]\\nIn: [1,1024,1024]\\nOut: [1,1024,1024]", shape=rectangle, fillcolor=lightblue, style=filled];
            l0_expert_3 [label="L0-Expert-3\\nEP64[48-63]\\nIn: [1,1024,1024]\\nOut: [1,1024,1024]", shape=rectangle, fillcolor=lightblue, style=filled];
            l0_expert_4 [label="L0-Expert-4\\nEP64[64-79]\\nIn: [1,1024,1024]\\nOut: [1,1024,1024]", shape=rectangle, fillcolor=lightblue, style=filled];
            l0_expert_5 [label="L0-Expert-5\\nEP64[80-95]\\nIn: [1,1024,1024]\\nOut: [1,1024,1024]", shape=rectangle, fillcolor=lightblue, style=filled];
            l0_expert_6 [label="L0-Expert-6\\nEP64[96-111]\\nIn: [1,1024,1024]\\nOut: [1,1024,1024]", shape=rectangle, fillcolor=lightblue, style=filled];
            l0_expert_7 [label="L0-Expert-7\\nEP64[112-127]\\nIn: [1,1024,1024]\\nOut: [1,1024,1024]", shape=rectangle, fillcolor=lightblue, style=filled];
            
            // Continue with remaining experts (8-63) - abbreviated for space
    ...
    subgraph cluster_stage1 {
        ...
        subgraph cluster_layer8_moe {
            ...
            l8_expert_0 [label="L8-Expert-0\\nEP64[1024-1039]\\nIn: [1,1024,1024]\\nOut: [1,1024,1024]", shape=rectangle, fillcolor=lightblue, style=filled];
            l8_expert_1 [label="L8-Expert-1\\nEP64[1040-1055]\\nIn: [1,1024,1024]\\nOut: [1,1024,1024]", shape=rectangle, fillcolor=lightblue, style=filled];
            l8_expert_2 [label="L8-Expert-2\\nEP64[1056-1071]\\nIn: [1,1024,1024]\\nOut: [1,1024,1024]", shape=rectangle, fillcolor=lightblue, style=filled];
            l8_expert_3 [label="L8-Expert-3\\nEP64[1072-1087]\\nIn: [1,1024,1024]\\nOut: [1,1024,1024]", shape=rectangle, fillcolor=lightblue, style=filled];
            
            l8_expert_4_15 [label="L8-Experts-4-15\\nEP64[1088-1279]\\n(12 experts total)\\nIn: [12,1024,1024]\\nOut: [12,1024,1024]", shape=rectangle, fillcolor=lightblue, style=filled];
    ...
    l0_dispatch -> l0_expert_0;
    l0_dispatch -> l0_expert_1;
    l0_dispatch -> l0_expert_2;
    l0_dispatch -> l0_expert_3;
    ...
    l0_expert_0 -> l0_combine [style=dashed];
    l0_expert_1 -> l0_combine [style=dashed];
    l0_expert_2 -> l0_combine [style=dashed];
    l0_expert_3 -> l0_combine [style=dashed];
    ...
    l8_dispatch -> l8_expert_0;
    l8_dispatch -> l8_expert_1;
    l8_dispatch -> l8_expert_2;
    l8_dispatch -> l8_expert_3;
    l8_dispatch -> l8_expert_4_15;
    l8_dispatch -> l8_expert_16_31;
    l8_dispatch -> l8_expert_32_47;
    l8_dispatch -> l8_expert_48_63;
    
    l8_expert_0 -> l8_combine [style=dashed];
    l8_expert_1 -> l8_combine [style=dashed];
    l8_expert_2 -> l8_combine [style=dashed];
    l8_expert_3 -> l8_combine [style=dashed];
    l8_expert_4_15 -> l8_combine;
