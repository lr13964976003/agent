    ...
    "baseline": {
      ...
      "device_mapping": {
        "GPU_0": {
          ...
          "shard_responsibility": "Tensor parallel shard 0"
        },
        "GPU_1": {
          "pipeline_stage": 0,
          "tensor_parallel_rank": 1,
          "layers": "0-7",
          "experts": "Expert_2, Expert_3",
          "shard_responsibility": "Tensor parallel shard 1"
        }
      }
    },
    "proposed": {
      ...
      "device_mapping": {
        "layer_0": {
          "GPU_0": {
            "expert_id": 0,
            "responsibility": "Expert 0 for Layer 0",
            "memory_allocation": "Complete expert MLP (4096->16384->4096)",
            "communication_role": "Receives tokens for Expert 0, sends processed tokens"
          },
          "GPU_1": {
            "expert_id": 1,
            "responsibility": "Expert 1 for Layer 0",
            "memory_allocation": "Complete expert MLP (4096->16384->4096)",
            "communication_role": "Receives tokens for Expert 1, sends processed tokens"
          }
        }
      }
    }
